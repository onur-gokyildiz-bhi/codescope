...
- [Full 52-tool reference](references/TOOLS.md) — all MCP tools with params and descriptions
- [SurrealQL syntax guide](../cs-query/references/SURREALQL.md) — graph traversal, tables, anti-patterns
