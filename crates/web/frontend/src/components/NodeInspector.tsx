  ...
  return (
    <>
      ...
      <div class="inspector-tabs">
        <button class={`inspector-tab ${tab() === 'details'  ? 'active' : ''}`} onClick={() => setTab('details')}>Details</button>
        <Show when={!isKnowledge(node()?.kind ?? '')}>
          <button class={`inspector-tab ${tab() === 'callers'  ? 'active' : ''}`} onClick={() => setTab('callers')}>
            Callers{detail()?.callers?.length ? ` (${detail().callers.length})` : ''}
          </button>
          <button class={`inspector-tab ${tab() === 'callees'  ? 'active' : ''}`} onClick={() => setTab('callees')}>
            Callees{detail()?.callees?.length ? ` (${detail().callees.length})` : ''}
          </button>
          <button class={`inspector-tab ${tab() === 'knowledge' ? 'active' : ''}`} onClick={() => setTab('knowledge')}>Knowledge</button>
        </Show>
      </div>
      ...
      <div class="right-panel-body">
        ...
        {/* Details tab */}
        <Show when={tab() === 'details' && !loadingDetail()}>
        ...
        {/* Callers tab */}
        <Show when={tab() === 'callers' && !loadingDetail()}>
          <div class="panel-body">
        ...
        {/* Callees tab */}
        <Show when={tab() === 'callees' && !loadingDetail()}>
          <div class="panel-body">
        ...
        {/* Knowledge tab */}
        <Show when={tab() === 'knowledge' && !loadingDetail()}>
          <div class="panel-body">
